...
const result = await esbuild.build({
  ...
  external: ['better-sqlite3', 'ethers', 'express', '@ardrive/turbo-sdk', 'o1js', '@solana/kit', '@solana-program/token', '@toon-protocol/mina-zkapp', '@toon-protocol/memvid-node', 'mina-signer'],
